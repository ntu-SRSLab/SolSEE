contract _MAIN_ {
    ...
    function startNewBallot(bytes32 ballotName, bool blindParam, bytes32[] memory proposalNames) public returns (bool success){
    ...
    /*Voting function*/
    function vote(address chainperson, uint256 ballot, uint256 proposalNum) public returns (bool success){
    ...
    function finishBallot(bytes32 ballot) public returns (bool success){
    ...
    constructor () public {
        ...
        proposalNames[1] =  "B";
        proposalNames[2] =  "C";
        startNewBallot(ballotName, blindParam, proposalNames);
        vote(msg.sender, 0, 1);

        uint proposalNum;
        proposalNum = getVotedData(msg.sender, 0, msg.sender);

        // The following assertion always holds
        assert(proposalNum == 1);
        // The following assertion doesn't hold,
        // (proposalNum == 1) is true
